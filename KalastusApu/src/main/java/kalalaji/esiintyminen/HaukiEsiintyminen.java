 ...
 * @author mikko
 */
public enum HaukiEsiintyminen implements Esiintyminen {
     ...
     */
    HaukiEsiintyminen(String esTalvi, String esKevat, String esKesa, String esSyksy) {
        this.talvi = esTalvi;
        this.kevat = esKevat;
        this.kesa = esKesa;
        this.syksy = esSyksy;
    ...
    public String esiintyySesonginMukaan(Esiintyminen es, SesonkiNyt sn) {
        ...
        switch (sn.getSesonki()) {
            case "TALVI":
                return es.getTalviEsiintyminen();
            case "KEVÄT":
                return es.getKevatEsiintyminen();
            case "KESÄ":
                return es.getKesaEsiintyminen();
            case "SYKSY":
                return es.getSyksyEsiintyminen();
            default:
